            ...
            return RawKeyboardListener(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  blackTile('Db', 1, whiteWidth, constraints.maxHeight / 1.7),
                  blackTile('Eb', 2, whiteWidth, constraints.maxHeight / 1.7),
                  blackTile('Gb', 4, whiteWidth, constraints.maxHeight / 1.7),
                  blackTile('Ab', 5, whiteWidth, constraints.maxHeight / 1.7),
                  blackTile('Bb', 6, whiteWidth, constraints.maxHeight / 1.7),
                ],
              ),
            );
          },
  ...
  Widget whiteTile(String tone, double position, double whiteWidth) {
    return Positioned(
      ...
      child: RawMaterialButton(
        ...
        splashColor: Color.fromARGB(77, 13, 255, 255),
